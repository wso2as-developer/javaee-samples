...
package org.wso2.appserver.javaee.jpa.servlet;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("placeOrder") != null) {
            ...
            try {
                ...
                request.setAttribute("info", "Please enter an integer as the quantity");
            ...
            try {
                ...
                request.setAttribute("info", "Please place an order first");
            }
            displayOrderList(request, response);
